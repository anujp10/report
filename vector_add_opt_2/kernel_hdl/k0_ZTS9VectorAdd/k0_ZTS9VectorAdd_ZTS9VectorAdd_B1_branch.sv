...
// SystemVerilog created from k0_ZTS9VectorAdd_ZTS9VectorAdd_B1_branch
...
module k0_ZTS9VectorAdd_ZTS9VectorAdd_B1_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] ZTS9VectorAdd_B1_branch_enable_q;
    wire [0:0] ZTS9VectorAdd_B1_branch_enable_not_q;
    ...
    begin
        ...
        else if (ZTS9VectorAdd_B1_branch_enable_q == 1'b1)
        begin
    ...
    // ZTS9VectorAdd_B1_branch_enable(LOGICAL,2)
    assign ZTS9VectorAdd_B1_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // ZTS9VectorAdd_B1_branch_enable_not(LOGICAL,3)
    assign ZTS9VectorAdd_B1_branch_enable_not_q = ~ (ZTS9VectorAdd_B1_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = ZTS9VectorAdd_B1_branch_enable_not_q;
